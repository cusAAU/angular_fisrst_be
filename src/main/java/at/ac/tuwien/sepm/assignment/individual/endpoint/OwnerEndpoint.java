...
public class OwnerEndpoint {
    ...
    //<editor-fold desc="original: public OwnerDto getOneById">
    @GetMapping(value = "/{id}")
    ...
    public Owner insertOwner(@RequestBody OwnerDto ownerDto){
        LOGGER.info("POST" + BASE_URL +"/{}",Owner.getOwnerCount());
        return ownerService.insertOwner(new Owner(ownerDto.getName()));
    }
